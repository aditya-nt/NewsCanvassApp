...
export default class NewsDecodedCard extends Component {
    ...
    render() {
        ...
        return (
            <div className="video_box  p-3" onClick={() => this.props.history.push("/NewsDecodedPosts/"+this.props.entry.id)}>
